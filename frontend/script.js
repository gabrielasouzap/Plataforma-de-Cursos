...
<div class="course-card">
  <div class="course-img">
      <img src="${infos.image}" class="course-thumb" alt="">
      <button onclick="window.location.href='http://localhost:3000/cursos/uxDesign.html?id=${infos.id}'" class="card-btn">SAIBA MAIS</button>
  </div>
